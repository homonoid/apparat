...
return  - 1 ;
 ...
 array_string array_string_filter2(array_string a, bool (*predicate)( string p_val, int p_i, array_string p_arr /*FFF*/ )) {
...
return  res ;
 ...
 array_int array_int_filter2(array_int a, bool (*predicate)( int p_val, int p_i, array_int p_arr /*FFF*/ )) {
...
return  strconv__parse_int ( s , 0 , 32 ) ;
...
return  strconv__parse_uint ( s , 0 , 32 ) ;
